#!/bin/sh
module_name="difficulty_selector";   # The module we are simulating
testbench_name="difficulty_selector_tb";   # The testbench used for the simulation
...
echo -e "\n *** Note: ./simulate.sh may not work. Just use Run. ***"
gtkwave waveform.vcd # Open resulting waveform in GTKWave (hidden save file).
